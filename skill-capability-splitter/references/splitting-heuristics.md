...
在使用这些启发式之前，先完成第一性原理定义（最小任务单元、输入/输出、完成判据）。启发式用于“优化拆分”，不能替代问题定义。
...
3. 它有自己的正确性标准
4. 它有明确的不负责项
5. 它有自己的完成判据（Definition of Done）
...
- 如果所谓“编排技能”内部重新实现了原子技能的方法论，则说明边界设计失败，应回退重构。
...
## 6. 第一性原理校验（Quick Sanity Check）

在正式输出方案前快速问 4 个问题：

1. 这个子技能如果没有上游结果，是否还能独立完成某个可验证产物？
2. 这个子技能的“正确性”是否有独立判据？
3. 这个子技能是否在重复另一个子技能的核心方法？
4. 这个子技能是否只是“章节切片”而不是能力单元？

任意一个回答为“是/不确定”，需回到拆分边界重新设计。
